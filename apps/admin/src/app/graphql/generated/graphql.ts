...
export type ProductsQuery = { products: Array<{ id: string, title: string, description: string, photoUrl: string | null, price: number }> };
...
export type ProductQuery = { product: { id: string, title: string, description: string, photoUrl: string | null, price: number } | null };
...
export type CreateProductMutation = { createProduct: { id: string, title: string, description: string, photoUrl: string | null, price: number } };
...
export type UpdateProductMutation = { updateProduct: { id: string, title: string, description: string, photoUrl: string | null, price: number } };
