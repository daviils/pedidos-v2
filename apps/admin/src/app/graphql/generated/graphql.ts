...
export type TableSessionsOpenQuery = { tableSessionsOpen: Array<{ id: string, tableId: string, openingDate: any, closingDate: any | null, status: TableSessionStatus, totalValue: number | null, table: { id: string, name: string } }> };
